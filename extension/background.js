...
chrome.runtime.onConnect.addListener((port) => {
  ...
  port.onMessage.addListener((msg) => {
    ...
    // provider 选择哪个后端（claude / codex）；缺省时 host 回退 claude，向后兼容。
    native.postMessage({ type: msg.type || "ask", context: msg.context, question: msg.question, scenario: msg.scenario, sessionId: msg.sessionId, transcript: msg.transcript, provider: msg.provider });
  });
